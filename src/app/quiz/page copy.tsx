...
export default function Home() {
  ...
  const quiz = [
      {text:'Qn1',options:['Opt 1','Opt 2','Opt 3','Opt 4'],answer:'Opt 2'},
      {text:'Qn2',options:['Opt 1','Opt 2','Opt 3','Opt 4'],answer:'Opt 3'},
      {text:'Qn3',options:['Opt 1','Opt 2','Opt 3','Opt 4'],answer:'Opt 4'},
      {text:'Qn4',options:['Opt 1','Opt 2','Opt 3','Opt 4'],answer:'Opt 1'},
  ];
            ...
            <CardContent>
              ...
              <div className="flex ml-10">
                <RadioGroup defaultValue="option-one">
                  ...
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="opt4" id="opt4" />
                    <Label htmlFor="option-two">Option Two</Label>
                  </div>
                </RadioGroup>
              </div>
