...
export default function Home() {
  ...
  const form = useForm<z.infer<typeof FormSchema_quiz>>({
    resolver: zodResolver(FormSchema_quiz),
  })

  const form2 = useForm<z.infer<typeof FormSchema_name>>({
  ...
  return (
    ...
    {!quizDone && quiz.map((questionText, i) => {
      ...
      <Card>
        ...
        <CardContent>
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onQuestionSubmit)} className="space-y-8">
              <FormField
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className='mt-5 mx-auto w-4/5'>
              <Form {...form}>
                <form onSubmit={form2.handleSubmit(onScoreSubmit)}>
                  <FormField
